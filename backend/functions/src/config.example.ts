...
export const config = {
  ...
  automl: {
    endpoint: process.env.AUTOML_ENDPOINT || 'https://asia-south1-aiplatform.googleapis.com/v1/projects/smart-surf-469908/locations/asia-south1/endpoints/1234567890123456789:predict',
    modelId: process.env.AUTOML_MODEL_ID || '1234567890123456789',
    projectId: process.env.PROJECT_ID || 'smart-surf-469908',
