...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen relative overflow-hidden transition-colors duration-300 ${
      ...
      {/* Theme Toggle and Language Selector - Top Right */}
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className={`max-w-md w-full space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="text-center">
            <div className="mx-auto h-20 w-20 bg-purple-200 rounded-2xl flex items-center justify-center shadow-2xl transform hover:scale-105 transition-transform duration-300 overflow-hidden">
              <img 
                src="/Logo.png" 
                alt="Manoday Logo" 
          ...
          <div className="space-y-6">
              ...
              >
                {isLoading === 'Anonymous' ? (
                  ...
                  <>
                    ...
                    <span className="ml-2 text-xs bg-purple-100 text-purple-700 px-2 py-1 rounded-full">{t('no_account')}</span>
                  </>
                )}
              </button>
            </div>
            ...
            <div className="text-center">
              <p className={`text-xs transition-colors duration-300 ${
                ...
                <button className="text-purple-600 hover:text-purple-500 bg-transparent border-none p-0 underline font-medium">{t('privacy_policy')}</button>
                {' '}{t('and')}{' '}
                <button className="text-purple-600 hover:text-purple-500 bg-transparent border-none p-0 underline font-medium">{t('terms_of_service')}</button>
              </p>
            </div>
          </div>
